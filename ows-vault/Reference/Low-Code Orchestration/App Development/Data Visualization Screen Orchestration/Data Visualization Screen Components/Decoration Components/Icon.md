---
title: "Icon"
source: "https://1057-sg-studio.teleows.com/adc-studio-project-mgt/web/rest/help/doc/en_US/component/icon.html"
depth: 5
---
#### Properties
...
| Rotate | Rotation angle of the component with the center as the center point. The unit is degree (°). | -   **Basic Properties**: icon type
    
    ![[en-us_image_0000001607318749.png]]
    
    -   **Icon**: You can select an existing icon and upload it.
