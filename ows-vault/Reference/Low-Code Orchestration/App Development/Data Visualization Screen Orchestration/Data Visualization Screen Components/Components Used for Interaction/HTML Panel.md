---
title: "HTML Panel"
source: "https://1057-sg-studio.teleows.com/adc-studio-project-mgt/web/rest/help/doc/en_US/component/htmlPanel.html"
depth: 5
---
#### Properties
...
| Rotate | Rotation angle of the component with the center as the center point. The unit is degree (°). | ![[en-us_image_0000001556366854.png]]

**Table 2** Basic Properties  
| Name | Description |
| :-- | :-- |
| Code | Code. HTML code can be entered. |