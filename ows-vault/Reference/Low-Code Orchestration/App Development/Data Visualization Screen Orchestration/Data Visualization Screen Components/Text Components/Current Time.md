---
title: "Current Time"
source: "https://1057-sg-studio.teleows.com/adc-studio-project-mgt/web/rest/help/doc/en_US/component/visualTime.html"
depth: 5
---
#### Properties
...
| Rotate | Rotation angle of the component with the center as the center point. The unit is degree (°). | ![[en-us_image_0000001556483944.png]]

![[en-us_image_0000001556484896.png]]

**Table 2** Properties  
| Name | Description |
| :-- | :-- |
| Date Format | Format of the current time. You can manually enter a value. |
| Show Week | Whether to display the week. |
| Default Style | Font style of the current time. |