---
title: "Scatter Chart"
source: "https://1057-sg-studio.teleows.com/adc-studio-project-mgt/web/rest/help/doc/en_US/component/bubbleChart.html"
depth: 6
---
#### Properties
...
| Rotate | Rotation angle of the component with the center as the center point. The unit is degree (°). | ![[en-us_image_0000001607500629.png]]
...
| Padding | Drawing grid margin in the rectangular coordinate system. | ![[en-us_image_0000001607341529.png]]
...
| Text Style | Common text style of the legend. You can set Font Family, Font Weight, Font Size, and Font Color. | ![[en-us_image_0000001607382625.png]]
...
| Max | Maximum scale of the coordinate axis. You can set this parameter to Data Max. In this case, the maximum value of the data on the axis is used as the maximum scale. If this parameter is not set, the maximum value is automatically calculated to ensure even distribution of axis scales. |
| Name | Axis name. |
...
| Split Line | Split line of the axis in the grid area. You can click to determine whether to display the split line. | ![[en-us_image_0000001557261076.png]]

**Table 5** Axis Tick  
| Name | Description |
| :-- | :-- |
| Inside | Whether the axis scale faces inwards. By default, the axis scale faces outwards. |
| Length | Length of the axis scale. |
| Line Style | Style settings of the scale line. | ![[en-us_image_0000001607341513.png]]
...
| Margin | Distance between the scale label and the axis. |
| Text Style | Text font style. |
| Formatter | Content format of the scale label. | ![[en-us_image_0000001557261044.png]]
...
| Split Line | Split line of the axis in the grid area. You can click to determine whether to display the split line. | ![[en-us_image_0000001557101060.png]]
...
| Text Style | Text style of the floating layer of the prompt. | **Series**: You can add multiple series and set different display modes for data of different series.

![[en-us_image_0000001607500893.png]]

**Table 9** Series  
| Name | Description |
| :-- | :-- |
| Name | Series name, which is used to show prompts and filter legends. |
| Symbol Size | Scatter size. |
| Color | Scatter color. |
| Border Color | Scatter border color. |
| Border Width | Stroke width. |
| Show | Whether to display the scatter data values. |