...
source: "https://1057-sg-studio.teleows.com/adc-studio-project-mgt/web/rest/help/doc/en_US/component/lineAreaChart.html"
depth: 6
---
#### Properties
...
| Rotate | Rotation angle of the component with the center as the center point. The unit is degree (°). | ![[en-us_image_0000001556513134.png]]
...
| Padding | Drawing grid margin in the rectangular coordinate system. | ![[en-us_image_0000001606845673.png]]
...
| Text Style | Common text style of legends. | ![[en-us_image_0000001606910333.png]]

![[en-us_image_0000001607189997.png]]
...
| Split Line | Split line of the axis in the grid area. You can click to determine whether to display the split line. | ![[en-us_image_0000001607070013.png]]
...
| Line Style | Style settings of the scale line. | ![[en-us_image_0000001607270425.png]]
...
| Text Style | Text font style. | ![[en-us_image_0000001556710112.png]]

![[en-us_image_0000001607189989.png]]
...
| Split Line | Split line of the axis in the grid area. You can click to determine whether to display the split line. | ![[en-us_image_0000001556231216.png]]
...
| Line Style | Style of the axis indicator line. | ![[en-us_image_0000001556390496.png]]

![[en-us_image_0000001556390500.png]]
...
| Label | Text label on a chart, which can be used to describe some data information of the chart, such as the value and name. You can click to determine whether to display the text label. | ![[en-us_image_0000001606911173.png]]
