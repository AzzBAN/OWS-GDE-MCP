---
title: "Ring Chart"
source: "https://1057-sg-studio.teleows.com/adc-studio-project-mgt/web/rest/help/doc/en_US/component/pieDoughnutChart.html"
depth: 6
---
#### Properties
...
| Rotate | Rotation angle of the component with the center as the center point. The unit is degree (°). | ![[en-us_image_0000001606833453.png]]
...
| Interval | Dwell duration on a single piece of data during play. | ![[en-us_image_0000001556250184.png]]
...
| Text Style | Common text style of legends. | ![[en-us_image_0000001607208877.png]]
...
| Border Radius | Radius of the rounded corner of the sector. | ![[en-us_image_0000001606931233.png]]
...
| Text Style | Style of the description text. | ![[en-us_image_0000001556411376.png]]

**Table 6** Halo Effect  
| Name | Description |
| :-- | :-- |
| Show | Whether to enable the halo effect at the edge. |
| Color | Fill color at the edge of the ring. | ![[en-us_image_0000001607210869.png]]
