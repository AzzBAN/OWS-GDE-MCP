...
source: "https://1057-sg-studio.teleows.com/adc-studio-project-mgt/web/rest/help/doc/en_US/component/horizontalBarStackChart.html"
depth: 6
---
#### Properties
...
| Rotate | Rotation angle of the component with the center as the center point. The unit is degree (°). | ![[en-us_image_0000001556673142.png]]
...
| Padding | Drawing grid margin in the rectangular coordinate system. | ![[en-us_image_0000001606885633.png]]
...
| Text Style | Common text style of legends. | ![[en-us_image_0000001607205277.png]]
...
| Split Line | Split line of the axis in the grid area. You can click to determine whether to display the split line. | ![[en-us_image_0000001607285709.png]]
...
| Line Style | Style settings of the scale line. | ![[en-us_image_0000001556246496.png]]
...
| Formatter | Content format of the scale label. | ![[en-us_image_0000001556565396.png]]
...
| Split Line | Split line of the axis in the grid area. You can click to determine whether to display the split line. | ![[en-us_image_0000001556405772.png]]
...
| Line Style | Style of the axis indicator line. | ![[en-us_image_0000001556725380.png]]
...
| Label | Text label on a chart, which can be used to describe some data information of the chart, such as the value and name. You can click to determine whether to display the text label. | ![[en-us_image_0000001606925645.png]]
