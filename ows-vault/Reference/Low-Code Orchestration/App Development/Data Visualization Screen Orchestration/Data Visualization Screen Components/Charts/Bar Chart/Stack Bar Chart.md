...
source: "https://1057-sg-studio.teleows.com/adc-studio-project-mgt/web/rest/help/doc/en_US/component/barStackChart.html"
depth: 6
---
#### Properties
...
| Rotate | Rotation angle of the component with the center as the center point. The unit is degree (°). | ![[en-us_image_0000001556513142.png]]
...
| Padding | Drawing grid margin in the rectangular coordinate system. | ![[en-us_image_0000001556685346.png]]
...
| Text Style | Common text style of legends. | ![[en-us_image_0000001556563776.png]]
...
| Split Line | Split line of the axis in the grid area. You can click to determine whether to display the split line. | ![[en-us_image_0000001606924017.png]]
...
| Line Style | Style settings of the scale line. | ![[en-us_image_0000001607203665.png]]
...
| Formatter | Content format of the scale label. | ![[en-us_image_0000001556404160.png]]
...
| Split Line | Split line of the axis in the grid area. You can click to determine whether to display the split line. | ![[en-us_image_0000001556244884.png]]
...
| Line Style | Style of the axis indicator line. | ![[en-us_image_0000001607083693.png]]
...
| Label | Text label on a chart, which can be used to describe some data information of the chart, such as the value and name. You can click to determine whether to display the text label. | ![[en-us_image_0000001607284085.png]]
