---
title: "Multi-Value Axis Scaling Chart"
source: "https://1057-sg-studio.teleows.com/adc-studio-project-mgt/web/rest/help/doc/en_US/component/barAreaChart.html"
depth: 6
---
#### Properties
...
| Rotate | Rotation angle of the component with the center as the center point. The unit is degree (°). | ![[en-us_image_0000001606873365.png]]
...
| Padding | Drawing grid margin in the rectangular coordinate system. | ![[en-us_image_0000001556525362.png]]
...
| Text Style | Common text style of legends. | ![[en-us_image_0000001607284097.png]]
...
| Split Line | Split line of the axis in the grid area. You can click to determine whether to display the split line. | ![[en-us_image_0000001607203669.png]]
...
| Line Style | Style settings of the scale line. | ![[en-us_image_0000001606924021.png]]
...
| Formatter | Content format of the scale label. | ![[en-us_image_0000001556244888.png]]
...
| Name Gap | Distance between the axis name and axis line. |
| Name Rotate | Rotation angle of an axis name. |
| Axis Line | Axis configurations. You can click to determine whether to display the axis. |
...
| Split Line | Split line of the axis in the grid area. You can click to determine whether to display the split line. | ![[en-us_image_0000001607083697.png]]
...
| Line Style | Style of the axis indicator line. | ![[en-us_image_0000001556721624.png]]

**Table 9** Series  
| Name | Description |
| :-- | :-- |
| Name | Series name, which is used to show prompts and filter legends. |
| Bar Width | Width of a bar. |
| Color | Chart color. |
| Border Radius | Radius of the rounded corner. |
| Stack | Data stacking. |
| Show Background | Whether to display the bar background. |
| Background Color | Bar background color. |
| Label | Text label on a chart, which can be used to describe some data information of the chart, such as the value and name. You can click to determine whether to display the text label. | ![[en-us_image_0000001556563780.png]]
